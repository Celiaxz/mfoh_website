      ...
      <div className={styles.partner}>
        <div className={styles.partnerContainer}>
          <div className={styles.partnerDescription}>
            ...
            brand and services. Consumer Perception: Sponsoring this project
            shows the human side of you, there is nothing that wins a customer’s
            heart than social responsibility, customers will perceive your
            ...
            The participation of girls of all the races and nationalities in
            these contests erases borders between states and excludes racism and
            any other prejudices regarding particular social, religious or
            political principles. It promotes tourism: It allows room to
            showcase the great culture of the Nigerian people. It enriches
            international relations: Popular international competitions are
            participated in by different countries. A way for today’s youth to
            find new opportunities. It promotes local economic opportunities by
            promoting local businesses internationally. It becomes a channel to
            reach and help despondent communities around the world.
          </div>
